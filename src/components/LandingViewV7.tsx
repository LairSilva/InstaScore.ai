            ...
            <div className="pt-5 space-y-5">
              ...
              <div className="flex items-center justify-between bg-[#080B14]/90 p-4 rounded-2xl border border-white/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-white text-base font-display">InstaScore Bom</h3>
                    <p className="text-xs text-emerald-400 font-mono font-medium flex items-center gap-1">
                      <TrendingUp size={12} /> +18 pts de potencial mapeado
                    </p>
                  </div>
                </div>
          ...
          <div className="min-h-[320px] glass-panel p-6 rounded-2xl border border-white/10 relative flex flex-col justify-center">
            ...
            <AnimatePresence mode="wait">
              {demoState === "before" && (
                ...
                >
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-white/10">
                    <div>
                      <h4 className="font-bold text-white text-lg font-display">Perfil: @bruno.consultor (Exemplo)</h4>
              ...
              {demoState === "analyzing" && (
                ...
                >
                  <div className="w-16 h-16 border-4 border-[#E1306C] border-t-transparent rounded-full animate-spin mx-auto"></div>
                  <h4 className="text-lg font-bold text-white font-display">A IA está processando o perfil...</h4>
                ...
                >
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-white/10">
                    <div>
                      ...
                      <h4 className="font-bold text-white text-lg font-display">Plano de Ação Estrutural</h4>
                    </div>
                    <div className="text-right">
