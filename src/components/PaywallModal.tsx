...
export const PaywallModal: React.FC<PaywallModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl text-slate-100 overflow-hidden my-8">
        ...
        <button
          onClick={onClose}
          className="absolute top-5 right-5 p-2 text-slate-400 hover:text-slate-100 hover:bg-slate-800 rounded-full transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-slate-50 tracking-tight mb-2">
          Evolua seu Perfil com Inteligência Tática Completa
        </h2>

        {reason && (
          <div className="mb-4 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs sm:text-sm flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          {[
            ...
            <div key={idx} className="flex items-center gap-2.5 text-xs sm:text-sm text-slate-200 bg-slate-800/40 p-2.5 rounded-xl border border-slate-800">
        ...
        {/* Cycle Toggle */}
        <div className="flex items-center justify-center p-1 bg-slate-950 border border-slate-800 rounded-2xl mb-6 max-w-xs mx-auto">
          <button
          ...
          <button
            ...
            className={`flex-1 py-2 text-xs sm:text-sm font-medium rounded-xl transition-all flex items-center justify-center gap-1 ${
              cycle === 'annual'
                ? 'bg-indigo-600 text-white shadow-md'
                : 'text-slate-400 hover:text-slate-200'
            }`}
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <button
                ...
                className={`flex-1 p-3 rounded-2xl border text-xs sm:text-sm font-medium flex items-center justify-center gap-2 transition-all ${
                  paymentMethod === 'pix'
