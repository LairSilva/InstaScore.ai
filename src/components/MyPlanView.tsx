    ...
    <div className="max-w-4xl mx-auto px-4 py-8 text-slate-100">
      <div className="flex items-center justify-between mb-8">
        <div>
          <button
            onClick={onBack}
            className="text-xs text-slate-400 hover:text-slate-200 transition-colors mb-2 inline-flex items-center gap-1"
          >
          ...
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-50 flex items-center gap-3">
            ...
            {isPro && (
              <span className="bg-gradient-to-r from-amber-400 to-amber-600 text-slate-950 font-extrabold text-xs px-2.5 py-1 rounded-full flex items-center gap-1 shadow-md">
