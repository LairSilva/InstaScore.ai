...
export const ProContentGenerator: React.FC<ProContentGeneratorProps> = ({
  ...
  const executeProGeneration = async (tab: TabType) => {
    ...
    try {
      if (tab === 'reels') {
        const res = await fetch('/api/pro/reels-script', {
          method: 'POST',
        ...
        const res = await fetch('/api/pro/stories-sequence', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'x-user-id': userId },
          body: JSON.stringify({
            userId,
        ...
        const res = await fetch('/api/pro/positioning-strategy', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'x-user-id': userId },
          body: JSON.stringify({
            userId,
        ...
        const res = await fetch('/api/pro/tactical-calendar', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'x-user-id': userId },
          body: JSON.stringify({
            userId,
        ...
        const res = await fetch('/api/pro/generate-image', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'x-user-id': userId },
          body: JSON.stringify({
            userId,
